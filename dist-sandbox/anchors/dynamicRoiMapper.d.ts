...
export declare class DynamicROIMapper {
    static map(input: NormalizedInput, detection: DocumentDetection, calibration: PerspectiveCalibration, anchors: AnchorResult, logger: AuditLogger, pageNumber?: number): Promise<FieldRoi[]>;
