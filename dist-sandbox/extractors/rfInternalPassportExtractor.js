...
export class RfInternalPassportExtractor {
    static async extract(input, opts) {
        ...
        try {
            ...
            const rois = options.ocrVariant === "v2" ? buildVariant2RoisFromAnchors(resolvedRois, anchorBoxes, width, height) : resolvedRois;
            ...
            // dept_code
            {
                ...
                const baseRoi = useVariant2
                    ? expandRoi(roi, width, height, deptCodeAnchorBox === undefined
