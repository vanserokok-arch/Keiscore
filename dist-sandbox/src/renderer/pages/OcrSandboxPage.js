...
export function OcrSandboxPage() {
    ...
    const [fixtureSelection, setFixtureSelection] = useState(null);
    ...
    async function onRunOcr() {
        ...
        try {
            setProgress(30);
            const result = fixtureSelection === null
    ...
    function selectFixture(caseId, kind) {
