import { z } from "zod";
export declare const SandboxFileKindSchema: z.ZodEnum<{
    registration: "registration";
    passport: "passport";
}>;
export declare const SandboxPickFileRequestSchema: z.ZodObject<{
    kind: z.ZodEnum<{
        registration: "registration";
        passport: "passport";
    }>;
}, z.core.$strip>;
export declare const SandboxPickFileResponseSchema: z.ZodObject<{
...
export declare const SandboxOpenDebugDirRequestSchema: z.ZodObject<{
    dirPath: z.ZodString;
}, z.core.$strip>;
export declare const SandboxOpenDebugDirResponseSchema: z.ZodObject<{
    ok: z.ZodBoolean;
