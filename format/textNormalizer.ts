...
function stripControlAndJunk(value: string): string {
  return value
    .replace(/[\u0000-\u001f\u007f]+/gu, " ")
...
function toRussianVisualGlyphs(value: string): string {
  return value
    .replaceAll("B", "В")
    .replaceAll("M", "М")
    .replaceAll("H", "Н")
...
export function normalizeFioCandidate(input: string): string | null {
